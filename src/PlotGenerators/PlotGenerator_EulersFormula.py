...
from PlotGenerators.PlotGenerator import PlotGenerator


class PlotGenerator_EulersFormula(PlotGenerator) :
    ...
    def generate_plots(self) :
        ...
        while (azimuth <= 360) and self.proceed_with_plots :
            ...
            filename = self.dirname + "Eulers_formula_(" + str(elevation) + "," + str(azimuth) + ").svg"
